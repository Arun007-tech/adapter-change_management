...
class ServiceNowAdapter extends EventEmitter {
  ...
  getRecord(callback) {
     ...
     */
     const connector1 = new ServiceNowConnector(this.connector);
     connector1.get(this.connector.serviceNowTable, (data, error) => {
    if (error) {
  ...
  postRecord(callback) {
     ...
     */
     const connector1 = new ServiceNowConnector(this.connector);
      connector1.post(options.serviceNowTable, (data, error) => {
    if (error) {
